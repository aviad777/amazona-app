import {
    CART_EMPTY, ORDER_CREATE_FAIL, ORDER_CREATE_REQUEST,
    ORDER_CREATE_SUCCESS, ORDER_DETAILS_REQUEST,
    ORDER_DETAILS_FAIL, ORDER_DETAILS_SUCCESS,
    ORDER_PAYMENT_REQUEST, ORDER_PAYMENT_SUCCESS,
    ORDER_PAYMENT_FAIL, ORDER_MINE_LIST_REQUEST,
    ORDER_MINE_LIST_FAIL, ORDER_MINE_LIST_SUCCESS,
    ORDER_LIST_REQUEST, ORDER_LIST_FAIL, ORDER_LIST_SUCCESS,
    ORDER_DELETE_REQUEST, ORDER_DELETE_FAIL, ORDER_DELETE_SUCCESS,
...
export const payOrder = (order, paymentResult) => async (dispatch, getState) => {
    //I dont think we need the payload here......
